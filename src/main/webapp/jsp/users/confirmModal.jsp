...
<div id="confirm_modal" class="modal fade" tabindex="-3" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="remove_form" action="${appCtx}/users/remove">
				<div class="modal-body">
					<h6 class="pb-3">${data_table_msg_delete}</h6>
					<div class="form-group">
						<label for="remove_email">${users_table_th_email}</label>
						<input type="text" class="form-control" name="email" id="remove_email" readonly>
					</div>
					<div class="form-group">
						<label for="remove_name">${users_table_th_name}</label>
