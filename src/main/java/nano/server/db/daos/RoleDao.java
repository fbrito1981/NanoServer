...
public class RoleDao extends BaseDao<Role> {
	...
	@Override
	public Role getNewEntity(ResultSet resultSet) throws DBException {
		try {
			...
			throw new DBException(Role.class, e);
		}
	}
}
