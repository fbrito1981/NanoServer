...
public class EnergyLogDao extends BaseDao<EnergyLog> {
	private IDeviceService deviceService;
	
	public EnergyLogDao(IDeviceService deviceService) {
	...
	@Override
	public DBScript getSetScript(EnergyLog entity) {
		...
		script.addParam(new DBParam("mVolts", entity.getVolts(), false));
		script.addParam(new DBParam("mAmps", entity.getAmps(), false));
		script.addParam(new DBParam("mFrequency", entity.getFrequency(), false));
		script.addParam(new DBParam("mDifference", entity.getDifference(), false));
	...
	@Override
	public EnergyLog getNewEntity(ResultSet resultSet) throws DBException {
		try {
			Device device = deviceService.getDevice(resultSet.getString("deviceUuid"));
			
			EnergyLog energyLog = new EnergyLog(device,
					resultSet.getTimestamp("created"),
					resultSet.getFloat("volts"),
					resultSet.getFloat("amps"),
